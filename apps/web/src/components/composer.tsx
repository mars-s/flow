...
import { FileTypeIcon, FlowIcon } from '@/components/flow-icon'
import {
  useComposerCommands,
  useComposerFiles,
  useDaemonSettings,
          ...
          <section className="mb-2 rounded-xl border border-[color:var(--warning)]/30 bg-card p-3 shadow-lg">
            ...
            <div className="mt-3 flex flex-wrap justify-end gap-2">
              {permission.options.map((option) => (
                ...
                >
                  {option.allow && <FlowIcon name="check" />}
                  {option.label}
                </Button>
              ))}
            </div>
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="flex items-center gap-2">
              {busy && (
                ...
                >
                  {escapeStopArmed
                    ...
                    : <FlowIcon className="size-[18px]" name="stopFilled" />}
                </Button>
              )}
              <Button
              ...
              >
                <FlowIcon className="size-[14px]" name="paperclip" />
              </Button>
              {busy ? (
                hasDraft && (
                  <Button
          ...
          {question.options.map((option) => {
            ...
            return (
              ...
              >
                ...
                {checked && <FlowIcon className="size-3 shrink-0 text-primary" name="check" />}
              </button>
            )
          })}
        </div>
...
function ComposerAutocomplete({
  ...
  return (
    <div
      ...
      className="flow-popover-surface absolute bottom-[calc(100%+6px)] left-0 z-[70] w-full overflow-hidden rounded-[11px] p-1"
...
function AutocompleteRowContents({ row }: { row: ComposerAutocompleteRow }) {
  if (row.kind === 'command') {
    ...
    return (
      <>
        {command.scope === 'Skill'
          ? <FlowIcon className="size-3 text-[var(--text-tertiary)]" name="sparkle" />
          : <FlowIcon className="size-3 text-[var(--text-tertiary)]" name="command" />}
...
function ComposerAttachmentTile({
  ...
  const contents = attachment.is_image && source ? (
    ...
    <div className="flex size-full flex-col items-center justify-center gap-[5px] px-[5px]">
      {attachment.is_dir
        ? <FlowIcon className="size-4 text-[var(--text-tertiary)]" name="folder" />
  ...
  return (
    ...
    >
      ...
      >
        <FlowIcon className="size-[9px]" name="x" />
      </button>
    </div>
  )
}
...
function InteractionModeControl({
  ...
  return (
    ...
    >
      <FlowIcon className={cn('size-[10.5px] text-[var(--text-tertiary)]', plan && 'text-ring')} name={plan ? 'list' : 'wrench'} />
      ...
      <div className="overflow-hidden rounded-t-xl border border-b-0 bg-card py-1">
        {messages.map((message) => (
          ...
          >
            ...
            >
              <FlowIcon className="size-3 shrink-0 text-[var(--text-tertiary)]" name="queue" />
            ...
            <div className="flex shrink-0 items-center gap-0.5">
              {canSteer && (
                ...
                >
                  <FlowIcon className="size-[11px]" name="cornerDownRight" />
                  {t('composer.steer')}
                </button>
              )}
              <button
              ...
              >
                <FlowIcon className="size-3" name="trash" />
              </button>
              <ControlMenu
                caret={false}
                items={[
              ...
              >
                <FlowIcon className="size-3" name="ellipsis" />
              </ControlMenu>
            </div>
          </div>
        ))}
...
function BranchPicker({
  ...
  return (
    <Popover.Root modal={false} open={open} onOpenChange={updateOpen}>
      ...
      >
        <FlowIcon className="size-[11px] text-[var(--text-tertiary)]" name="gitBranch" />
      ...
      <Popover.Portal>
        ...
        >
          <Popover.Popup
            ...
            className="flow-popover-surface flex max-h-[390px] w-[360px] flex-col overflow-hidden rounded-[13px] outline-none"
            ...
            {mode === 'create' ? (
              <div className="p-3.5">
                <div className="flex items-center gap-2 text-[13px] font-medium">
                  <FlowIcon className="size-3.5 text-[var(--text-secondary)]" name="plus" />
              ...
              <>
                <div className="h-[52px] shrink-0 px-3 pb-2 pt-2.5">
                  <label className="flex h-[34px] items-center gap-2 rounded-[9px] bg-background px-2.5 focus-within:ring-1 focus-within:ring-ring">
                    <FlowIcon className="size-[15px] text-[var(--text-secondary)]" name="search" />
                    <input
                ...
                <div className="min-h-0 max-h-[260px] overflow-y-auto px-1">
                  ...
                  {visible.map((branch) => {
                    ...
                    return (
                      ...
                      >
                        <FlowIcon className="size-3 text-[var(--text-tertiary)]" name="gitBranch" />
                        <span className="min-w-0 flex-1 truncate">{branch.name}</span>
                        {branch.name === selected && <FlowIcon className="size-[11px] text-[var(--text-tertiary)]" name="check" />}
                      </button>
                    )
                  })}
                </div>
                {!plannedWorktree && (
                  <>
                    ...
                    >
                      <FlowIcon className="size-3 text-[var(--text-secondary)]" name="plus" />
      ...
      <Popover.Portal>
        ...
        >
          <Popover.Popup
            ...
            className="flow-popover-surface flex w-80 flex-col gap-3 rounded-[10px] p-3.5 text-xs text-popover-foreground outline-none"
            finalFocus={(closeType) => closeType === 'keyboard' ? true : returnFocus.current}
            initialFocus={false}
            role="dialog"
          >
    ...
    <>
      {usageUrl ? (
        ...
        >
          ...
          <FlowIcon className="size-2.5" name="arrowRight" />
        </a>
      ) : (
