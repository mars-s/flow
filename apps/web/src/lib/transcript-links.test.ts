...
describe('transcriptLinkRoute', () => {
  ...
  test('does not reinterpret another daemon path or an external URL', () => {
    expect(transcriptLinkRoute(
      '/Users/egoist/dev/flow/../kero/src/app.rs:20',
      workspace,
