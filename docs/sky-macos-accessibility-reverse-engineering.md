...
This is the critical path for Flow parity.
...
## Why Flow's previous approximation failed
...
## Compatibility requirements for Flow
...
1. Codex/Flow remains the actual frontmost application throughout.
